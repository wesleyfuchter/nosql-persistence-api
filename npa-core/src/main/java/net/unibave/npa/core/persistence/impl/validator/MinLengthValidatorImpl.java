...
public class MinLengthValidatorImpl extends AbstractValidator<Object, Object> {
    ...
    public Boolean validateField(Object o, Object fieldValue) throws Exception {
        return fieldValue.toString().length() >= ((Field) o).getAnnotation(MinLength.class).value();
    }
